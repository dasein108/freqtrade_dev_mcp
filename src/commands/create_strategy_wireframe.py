...
class CreateStrategyWireframeCommand(BaseCommand):
    ...
    async def execute(
        ...
        **kwargs,
        ...
        try:
            ...
            await self.mcp_log(
                "info", f"Strategy wireframe created successfully at {strategy_file_path}"
            )
    ...
    def _generate_wireframe_code(
        ...
        if style == "minimal":
            ...
            return self._generate_guided_wireframe(
                strategy_name, description, include_comments, include_examples
            )
        elif style == "structured":
            return self._generate_structured_wireframe(
                strategy_name, description, include_comments, include_examples
            )
        else:
            return self._generate_minimal_wireframe(strategy_name, description, include_comments)

    def _generate_minimal_wireframe(
        self, strategy_name: str, description: Optional[str], include_comments: bool
    ) -> str:
...
'''
    ...
    def _generate_guided_wireframe(
        self,
        strategy_name: str,
        description: Optional[str],
        include_comments: bool,
...
'''
    ...
    def _generate_structured_wireframe(
        self,
        strategy_name: str,
        description: Optional[str],
        include_comments: bool,
        ...
        desc = (
            description
            or f"Structured wireframe for {strategy_name} strategy with advanced features"
        )
