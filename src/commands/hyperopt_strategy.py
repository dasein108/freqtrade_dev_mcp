        ...
        try:
            ...
            if hyperopt_results:
                ...
                return {
                    ...
                    "best_metrics": {
                        "total_profit": best_result.get("results_metrics", {}).get(
                            "profit_total", 0.0
                        ),
                        "win_rate": best_result.get("results_metrics", {}).get("wins", 0)
                        / max(best_result.get("results_metrics", {}).get("total_trades", 1), 1),
                        "total_trades": best_result.get("results_metrics", {}).get(
                            "total_trades", 0
                        ),
                        "avg_profit": best_result.get("results_metrics", {}).get(
                            "profit_mean", 0.0
                        ),
                    },
                    "trials_summary": {
