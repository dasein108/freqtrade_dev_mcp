...
class TestMCPBaseResponse:
    ...
    def test_valid_response(self):
        ...
        response = MCPBaseResponse(command="test_command", success=True, duration_seconds=1.5)
    ...
    def test_error_response(self):
        ...
        response = MCPBaseResponse(
            command="test_command", success=False, error="Test error message"
        )
    ...
    def test_extra_fields_forbidden(self):
        ...
        with pytest.raises(ValidationError) as excinfo:
            MCPBaseResponse(command="test", success=True, extra_field="should_fail")
...
class TestCacheFileInfo:
    ...
    def test_default_candle_count(self):
        ...
        cache_info = CacheFileInfo(pair="BTC/USDT", filename="test.json", full_path="/test.json")
...
class TestDownloadCandlesResponse:
    ...
    def test_valid_download_response(self):
        ...
        cache_file = CacheFileInfo(
            pair="BTC/USDT:USDT", filename="test.json", full_path="/test.json", candle_count=100
        )
...
class TestPerformanceMetrics:
    ...
    def test_optional_fields(self):
        ...
        metrics = PerformanceMetrics(
            total_profit_pct=10.0, total_trades=50, win_rate=0.6, max_drawdown_pct=5.0
        )
...
class TestUtilityFunctions:
    ...
    def test_create_error_response(self):
        """Test error response creation."""
        response = create_error_response(command="test_command", error="Test error", duration=1.5)
    ...
    def test_create_success_response(self):
        ...
        response = create_success_response(command="test_command", duration=2.0)
