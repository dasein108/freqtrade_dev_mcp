...
MIT. Independent project built on top of Freqtrade (not affiliated with the Freqtrade team). See [LICENSE](../LICENSE).

## Support

- Bugs and feature requests: [GitHub Issues](https://github.com/dasein108/freqtrade_dev_mcp/issues)
